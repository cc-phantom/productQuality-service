...
* @date 2021-08-29
**/
public interface PqProductService {
    ...
    */
    Map<String,Object> queryAll(PqProductQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<PqProductDto>
    */
    List<PqProductDto> queryAll(PqProductQueryCriteria criteria);
    ...
    * @return PqProductDto
    */
    PqProductDto create(PqProduct resources);

    /**
    * 编辑
    * @param resources /
    */
    void update(PqProduct resources);
